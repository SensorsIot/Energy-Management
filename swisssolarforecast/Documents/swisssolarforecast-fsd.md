...
| Timeout | 300 seconds |
| GRIB storage | `/share/swisssolarforecast` |
...
The panel and plant geometry is defined in `/config/swisssolarforecast.yaml`:
...
| `storage.data_path` | /share/swisssolarforecast | GRIB storage path |
