...
Create `/config/swiss-solar-forecast.yaml`:
...
See [SwissSolarForecast FSD](Documents/swiss-solar-forecast-fsd.md) for the full design, configuration model, InfluxDB contract, and operational notes.
