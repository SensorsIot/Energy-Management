...
USER_CONFIG="/config/swiss-solar-forecast.yaml"
TEMPLATE="/usr/share/swiss-solar-forecast/swiss-solar-forecast.yaml.example"
EXAMPLE_DEST="/config/swiss-solar-forecast.yaml.example"
...
if [ ! -f "$USER_CONFIG" ]; then
  ...
  bashio::log.warning "Edit via: File Editor or VS Code at /addon_configs/swiss-solar-forecast/"
else
