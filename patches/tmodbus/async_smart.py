...
class AsyncSmartTransport(AsyncBaseTransport):
    ...
    # Consecutive timeout counter — triggers forced reconnect after threshold
    CONSECUTIVE_TIMEOUT_RECONNECT_THRESHOLD = 3
    ...
    def __init__(  # noqa: C901, PLR0913
        ...
        *,
        ...
        """
        # Fix: per-instance lock instead of class-level shared lock
    ...
    def _retry_with_new_connection_if_needed(self, retry_state: RetryCallState) -> bool:
        ...
        if retry_state.outcome and retry_state.outcome.failed:
            ...
            if isinstance(exception, TimeoutError):
                ...
                if self._consecutive_timeouts >= self.CONSECUTIVE_TIMEOUT_RECONNECT_THRESHOLD:
                    logger.warning(
                        "Received %d consecutive timeouts. Forcing reconnect to clear stale connection.",
