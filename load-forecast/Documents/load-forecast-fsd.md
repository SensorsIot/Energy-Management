...
[`Harness/project/modules/load-forecast.md`](../../Harness/project/modules/load-forecast.md).
...
### Non-secrets (`/config/load-forecast.yaml`)
...
Source-file layout is HOW — see [`Harness/project/modules/load-forecast.md`](../../Harness/project/modules/load-forecast.md).

## 10. Dependencies

Requires at least 7 days of historical load data (90+ recommended). The build dependency list is
HOW — see [`Harness/project/modules/load-forecast.md`](../../Harness/project/modules/load-forecast.md).
